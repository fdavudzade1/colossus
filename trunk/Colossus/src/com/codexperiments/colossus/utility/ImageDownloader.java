...
public class ImageDownloader
{
    ...
    private ConcreteQueue mQueue = new ConcreteQueue();
     ...
     * at the moment as its interest is not clear. private void forceDownload(String url, ImageView
     * view) { forceDownload(url, view, null); }
     */
    ...
    private static boolean cancelPotentialDownload (String url, ImageView imageView)
    {
        ...
        if (bitmapDownloaderTask != null) {
            ...
            if ((bitmapUrl == null) || (!bitmapUrl.equals(url))) {
                bitmapDownloaderTask.setCancelled(true);
            } else {
...
//        }
//    }
    class BitmapDownloaderTask implements RunnableTask
    {
        private String                         mUrl;
        private final WeakReference<ImageView> imageViewReference;
        ...
        public void setCancelled (boolean pIsCancelled)
        {
